<script>
    ...
    textContents: {
            ...
            paragraph13: "If we look at a single year of data, we can see how different stream temperature can be across the basin. Each line in the figure below represents temperature observations from one river reach in the DRB in 2019. In July, mean stream temperature across the basin differed by as much as 26 degrees on a single day. Additionally, you can see drastically different warming and cooling patterns, particularly below reservoirs where stream temperature can deviate from the normal seasonal patterns.",
            paragraph14: "Hover over a river reach on the map below to highlight temperature dynamics of a single reach. Alternatively, hover over a month on the line graph to view the average monthly temperature displayed on the map.",
            paragraph15: "The temperature observations in the basin can be used to inform models that help us predict temperature when or where observations are unavailable. Day ahead temperature forecasts, for example, can help managers decide when to release water from reservoirs. How can we create robust models that account for diverse temperature dynamics and make accurate predictions in places and times where we don't have a lot of information? Visit the Model chapter to learn about innovative modeling techniques to predict water temperature."
        }
    }
</script>
<style lang="scss">
