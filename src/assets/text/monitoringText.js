export default {
   textContents: {
        ...
        paragraph8: "In the figure below, we've simplified the variability in the amount of data in time and space into a matrix.",
