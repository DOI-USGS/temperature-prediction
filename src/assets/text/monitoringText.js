export default {
   textContents: {
        ...
        paragraph1: "At first glance, it appears that the USGS has a lot of information about stream temperature in the Basin. The map below shows medium to large streams and all places where temperature has ever been measured measured (white dots).",
        ...
        paragraph4: "Since 2017, an uptick in temperature monitoring can be attributed to the USGS's Next Generation Water Observing Systems (NGWOS). NGWOS is a targeted effort in the basin to develop and apply new monitoring techniques for a wide range of water characteristics.",
        paragraph5: "Temperature is one of the most widely measured water characteristics in the U.S. – temperature can now be monitored by boat, by camera, by drone, by cable, by satellite, by sensor, or by the tried and true method of a field technician sticking a thermometer into the water.",
        ...
        paragraph6: "The top 1% of measured river reaches - only about 5 sites - makes up nearly 20% of all data. There are whole chunks of space and time where we don't know anything about the river, where we're 'in the dark.'",
        ...
        paragraph8: "To show how gaps in temperature observations in space and time might impact our understanding of the river, we've simplified data availability into a matrix below.",
        ...
        paragraph13: "The matrix below shows a year of actual temperature data across all monitored sites in medium to large streams in the Delaware River Basin.",
