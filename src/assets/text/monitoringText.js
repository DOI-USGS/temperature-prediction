export default {
   textContents: {
        ...
        paragraph5: "NGWOS is a targeted effort in the basin to develop and apply new monitoring techniques for a wide range of water characteristics. Temperature is one of the most widely measured water characteristics in the U.S. – temperature can now be monitored by boat, by camera, by drone, by cable, by satellite, by sensor, or by the tried and true method of a field technician sticking a thermometer into the water.",
        ...
        paragraph7: "Watch as the animation lights up the reaches for which there is stream temperature data in each of the last forty years.",
        tiptext1: "Explore the availability of temperature observations across the Delaware River Basin by selecting a river reach (on the left) or a year (on the right) to explore where and when we have the most information.",
        ...
        paragraph9: "We can represent the availability of data as a matrix with two axes.",
