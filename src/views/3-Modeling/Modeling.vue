          ...
          >
            ...
            >
              ...
              <path
                id="RGCN_2"
                class="path1 river"
                d="M137.8,169a8.5,8.5,0,0,1-4.4-1.7c-.9-.8-1.1-2.1-1.4-4.2a37.1,37.1,0,0,0-1.5-7,8.5,8.5,0,0,1,1.7-6.2,7.2,7.2,0,0,0,1.1-1.9,6,6,0,0,0,.4-2.2,19.4,19.4,0,0,0-.2-4.2,8.5,8.5,0,0,0-1.5-4.1,7.4,7.4,0,0,0-3.5-2.8,21.7,21.7,0,0,0-4.1-.9,1.9,1.9,0,0,1-1.5-.5c-.1-.1-.1-.2-.1-.4a2.1,2.1,0,0,1,.4-.6,4.2,4.2,0,0,1,1.5-1.1,5.6,5.6,0,0,1,1.7-.9l2-.9a4,4,0,0,0,1.6-1.8,9.5,9.5,0,0,0,.7-4.4,15.5,15.5,0,0,0-.4-2.1,7.8,7.8,0,0,0-.9-2.1,16.1,16.1,0,0,0-5.6-6.3,6,6,0,0,0-2.1-.8l-2.1-.4a3.8,3.8,0,0,1-1.6-.6,4.7,4.7,0,0,1-1.1-1.3,5.5,5.5,0,0,1-.9-2.2,16.2,16.2,0,0,1-.1-2.2,11.9,11.9,0,0,1,1.1-4.1,13.1,13.1,0,0,1,2.7-3.5l1.6-1.5a9.1,9.1,0,0,0,1.7-1.7,41,41,0,0,0,2.3-4,20.8,20.8,0,0,0,1.9-4.3,20.4,20.4,0,0,0,.9-9.2c-.4-3.1-1.8-5.9-2.2-8.8A4.9,4.9,0,0,1,126,66a6.9,6.9,0,0,1,1-1.9,8.2,8.2,0,0,1,3.6-2.4l2.1-.8a4.1,4.1,0,0,0,1.1-.7,2.4,2.4,0,0,0,.6-1.1,4.8,4.8,0,0,0-.1-2.4c-.2-.8-.5-1.5-.7-2.2a8.9,8.9,0,0,1-.3-2.2,2.2,2.2,0,0,1,.9-1.7c1-1,2.6-.9,4.1-1s3.3-.4,4.3-1.9a3.9,3.9,0,0,0,.7-2.3,16.4,16.4,0,0,0-.2-2.3,13.6,13.6,0,0,0-1.2-4.5,25.6,25.6,0,0,0-2.2-4,16.9,16.9,0,0,0-2.9-3.7,19.7,19.7,0,0,0-3.8-2.6,7.5,7.5,0,0,1-3.3-2.8,21.9,21.9,0,0,1-2.1-4,10.8,10.8,0,0,1-.8-4.4c.1-1.5.3-3,.4-4.5a17.6,17.6,0,0,0,.2-4.6,5.2,5.2,0,0,0-2-4A7.8,7.8,0,0,0,121,2.7a23.2,23.2,0,0,0-4.6.4,51.5,51.5,0,0,0-8.6,3h0a46.4,46.4,0,0,1,8.7-2.8,16.5,16.5,0,0,1,4.5-.3,6.6,6.6,0,0,1,4.1,1.2A5,5,0,0,1,127,8.1a17,17,0,0,1-.2,4.5c-.2,1.5-.4,3-.5,4.5a19.3,19.3,0,0,0,.1,2.4,18,
,8.5,0,0,0,2.1,3.2,58.7,58.7,0,0,0-9.4-.4,15,15,0,0,0-9.8,4.1c-2.6,2.5-4.4,5.8-7.5,7.8a9,9,0,0,1-2.4,1.2l-2.6.5-5.4.4h0l5.4-.4a12.8,12.8,0,0,0,2.7-.5,10.8,10.8,0,0,0,2.4-1.2c3.1-2,5-5.2,7.5-7.7a14.3,14.3,0,0,1,9.8-3.9,65.7,65.7,0,0,1,9.9.5c1,.9,2.2,1.6,3.1,2.3l1.8,1.2a6.3,6.3,0,0,0,2.2.8,2.4,2.4,0,0,0,1.4-.2,2.8,2.8,0,0,0,1.1-.8,5.3,5.3,0,0,0,1.1-2.1,2.6,2.6,0,0,1,.7-1.3,1.6,1.6,0,0,1,1.3-.2c1,.1,2.7.6,3.2,1.3a13.6,13.6,0,0,0,1.4,1.9,5.3,5.3,0,0,0,2.3.8l2,.3,1.7.7a13.2,13.2,0,0,1,5.1,5.8,13,13,0,0,1,.8,1.7,6.3,6.3,0,0,1,.3,1.9,7.6,7.6,0,0,1-.5,3.7,2.8,2.8,0,0,1-1.1,1.3l-1.8.8-1.9.9a11,11,0,0,0-1.8,1.4,4.5,4.5,0,0,0-.6,1.2,2,2,0,0,0,.3,1.5,3.4,3.4,0,0,0,2.3,1,15.9,15.9,0,0,1,3.9.8,6,6,0,0,1,2.9,2.3,8.2,8.2,0,0,1,1.3,3.5,17.9,17.9,0,0,1,.2,4,5.8,5.8,0,0,1-.3,1.9,10.1,10.1,0,0,1-1,1.6,9.5,9.5,0,0,0-1.9,3.9,8.1,8.1,0,0,0,0,4.1,23.4,23.4,0,0,1,1.3,6.3c.3,2.2.7,4,1.8,4.9a7.2,7.2,0,0,0,4.2,1.8c2.5.5,4.8.9,6.4,4.2l1.6-.9C142.8,169.9,140.3,169.4,137.8,169Z"
              />
              <path
                id="RGCN_ptrn"
                class="path1 river"
            ...
            >
              ...
              <path
                id="RGCN_2"
                class="path3 other"
                d="M145.1,189.2a1,1,0,1,0,2,0,1,1,0,0,0-2,0"
              />
              <path
                id="RGCN_ptrn"
                class="path3 other"
            ...
            >
              ...
              <path
                id="RGCN_2"
                class="path4 other"
                d="M144.9,160.7a1,1,0,0,0,2,0,1,1,0,1,0-2,0"
              />
              <path
                id="RGCN_ptrn"
                class="path4 other"
...
<script>
  ...
  export default {
    ...
    data() {
        ...
        mounted() {
          ...
          this.model_list = ['ANN','RNN','RGCN','RGCN_ptrn','ANN', 'RNN', 'RGCN', 'RGCN_ptrn','ANN', 'RNN', 'RGCN', 'RGCN_ptrn','ANN'];
        ...
        methods: {
          ...
          callback(data) {
            ...
            // use step index to select model from model list and define data set
  ...
  /*             .attr('cy', function(d){return this.height/2;}) */
          ...
          updateChart(data) {
            ...
            // use step index to select from model_list
            var model_sel = self.model_list[data];
