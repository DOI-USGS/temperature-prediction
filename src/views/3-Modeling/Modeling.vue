          ...
          >
            ...
            >
              <path
                ...
                d="M87.1,26.2a5.8,5.8,0,1,1-11.5,0c0-3.2,4.7-7,5.8-13.3C82.4,19.1,87.1,23,87.1,26.2Z"
              />
              <path
                id="ANN2"
                class="path1 river flubber visuals"
            ...
            >
              ...
              <path
                id="ANN2"
                class="path7 blocker flubber visuals"
                d="M180.3,2.1H72.6a20.4,20.4,0,0,0,0,40.8h4.5V38.2a16.3,16.3,0,1,1,8.5,0v4.7h78.5V38.2a16.3,16.3,0,1,1,8.5,0v4.7h7.7a20.4,20.4,0,0,0,0-40.8Z"
              />
              <path
                id="ANN3"
                class="path7 blocker flubber visuals"
            ...
            >
              ...
              <path
                id="ANN3"
                class="path8 blocker flubber visuals"
                d="M202.9,70.7h-6.5v4.7a16.3,16.3,0,1,1-8.5,0V70.7H130.7v4.7a16.3,16.3,0,1,1-8.5,0V70.7H65.1v4.7a16.3,16.3,0,1,1-8.5,0V70.7H50.1a20.4,20.4,0,1,0,0,40.7H202.9a20.4,20.4,0,0,0,0-40.7Z"
              />
              <path
                id="ANN4"
                class="path8 blocker flubber visuals"
              ...
              <path
                id="ANN5"
                class="path8 blocker flubber visuals"
                d="M202.9,111.4h-6.5v-4.7a16.3,16.3,0,1,0-8.5,0v4.7H130.7v-4.7a16.3,16.3,0,1,0-8.5,0v4.7H65.1v-4.7a16.3,16.3,0,1,0-8.5,0v4.7H50.1a20.4,20.4,0,1,1,0-40.7H202.9a20.4,20.4,0,0,1,0,40.7Z"
              />
              <path
                id="ANN6"
                class="path8 blocker flubber visuals"
            ...
            <g
              ...
              transform="translate(0 0) scale(1.333 1.333)"
            >
              <text class="f_main bold" transform="translate(132.5 57.2)">Air temperature</text>
              <text class="f_main bold" transform="translate(38.8 57.2)">Precipitation</text>
            </g>
            <g
              id="ANN2_annotations"
              class="flubber annotations"
            ...
            >
              ...
              <g>
                <path class="f_arrow" d="M192,59.8c6-2.3,9.8-4.5,11.4-6.8"/>
              ...
              <line class="f_synapse low" x1="168.8" y1="44.8" x2="61.1" y2="68.9"/>
              <line class="f_synapse high" x1="168.8" y1="44.8" x2="126.5" y2="68.9"/>
              <line class="f_synapse medium" x1="168.8" y1="44.8" x2="192" y2="68.9"/>
            </g>
            <g
              id="ANN4_annotations"
              class="flubber annotations"
