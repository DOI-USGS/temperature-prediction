          ...
          >
            ...
            >
              ...
              <path
                id="RGCN_2"
                class="path3 other flubber visuals"
                d="M129.6,195.2a1.5,1.5,0,1,0,2.9,0A1.5,1.5,0,0,0,129.6,195.2Zm.3,0a1.2,1.2,0,0,1,2.3,0A1.2,1.2,0,1,1,129.9,195.2Z"
              />
              <path
                id="RGCN_ptrn"
                class="path3 other flubber visuals"
            ...
            >
              ...
              <path
                id="RGCN_2"
                class="path4 other flubber visuals"
                d="M129.4,166.7a1.5,1.5,0,0,0,3,0,1.5,1.5,0,1,0-3,0"
              />
              <path
                id="RGCN_ptrn"
                class="path4 other flubber visuals"
            ...
            transform="translate(0 25)">
              ...
              <g>
                <text class="f_sub" transform="translate(168.8 151.4) rotate(54.9)">F</text>
                <text class="f_sub" transform="matrix(0.56, 0.83, -0.83, 0.56, 172.65, 156.88)">l</text>
                <text class="f_sub" transform="matrix(0.54, 0.84, -0.84, 0.54, 174.51, 159.58)">o</text>
                <text class="f_sub" transform="translate(178.6 165.8) rotate(61.9)">w</text>
              </g>
              <g>
                <text class="f_sub" transform="translate(49.8 118.3) rotate(23.8)">F</text>
                <text class="f_sub" transform="matrix(0.94, 0.34, -0.34, 0.94, 56.13, 120.97)">l</text>
                <text class="f_sub" transform="translate(59.4 122.2) rotate(15.9)">o</text>
                <text class="f_sub" transform="translate(66.7 124.3) rotate(11.2)">w</text>
              </g>
            </g>
            <g
