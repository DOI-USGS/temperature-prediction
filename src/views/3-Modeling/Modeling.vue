          ...
          >
            ...
            >
              <path
                ...
                d="M25.9,79.8A15.5,15.5,0,1,0,41.4,95.3,15.4,15.4,0,0,0,25.9,79.8Zm3.9,22H22.2V99.6l4.4-5.7a5.6,5.6,0,0,1,.5-.8,2.5,2.5,0,0,0,.1-.8h0a1,1,0,0,0-.3-.8,1.5,1.5,0,0,0-1-.3,1,1,0,0,0-.9.4,1.6,1.6,0,0,0-.5,1.1H22.1a4.6,4.6,0,0,1,.5-2.1A4.4,4.4,0,0,1,24,89.3a3.8,3.8,0,0,1,1.9-.4,4.6,4.6,0,0,1,2.1.4,2.8,2.8,0,0,1,1.3,1.1,4.8,4.8,0,0,1,.4,1.8h0a4.7,4.7,0,0,1-.3,1.7,5.1,5.1,0,0,1-.9,1.6l-3.1,4h4.4Z"
              />
              <path
                id="ANN2"
                class="path1 river flubber visuals"
              ...
              <path
                id="ANN3"
                class="path1 river flubber visuals"
                d="M180.7,138.7v-.5l-6.5-67.6V70l-48.3,31.8L77.9,69.9l-9.2,69.2v.3h1.3l.3-.2.5-.3,54-35.6L179.8,140l.9-.6v-.7ZM70.8,138l8.6-64.6L124,103Zm55.7-35.8,47-30.9,6.3,66.3Z"
              />
              <path
                id="ANN4"
                class="path1 river flubber visuals"
              ...
              <path
                id="ANN7"
                class="path1 river flubber visuals"
                d="M184.8,138.5,173.9,66.6l-51,35.5L78.8,71.5l-.4-.3-9,68h.5l10.7,3.2,49.7-34.5,45.4,31.5h.1v.6l9.1-.2ZM70,138.9l8.8-66.8,43.7,30.3Zm60.8-31.3,36.4-25.3,8.5,56.5Z"
              />
              <path
                id="ANN8"
                class="path1 river flubber visuals"
            ...
            >
              <path
                ...
                d="M25.9,139.2a15.5,15.5,0,1,0,15.5,15.5A15.4,15.4,0,0,0,25.9,139.2Zm3.7,18.6a3.8,3.8,0,0,1-.4,1.9,3,3,0,0,1-1.3,1.2,4.2,4.2,0,0,1-2,.4,4.6,4.6,0,0,1-2.1-.4,3.3,3.3,0,0,1-1.4-1.2,3.4,3.4,0,0,1-.6-2h2.5a1.4,1.4,0,0,0,.2.7l.4.4.7.2a1.8,1.8,0,0,0,1.1-.4,1.8,1.8,0,0,0,.3-1.1v-.3a1.6,1.6,0,0,0-.3-1.1.9.9,0,0,0-.8-.4H24.8v-2.3h1.1a.8.8,0,0,0,.7-.4,2.2,2.2,0,0,0,.2-1v-.2a1.2,1.2,0,0,0-.3-.9.8.8,0,0,0-.7-.3l-.6.2a1,1,0,0,0-.5.4,2.4,2.4,0,0,0-.2.8H22a4.3,4.3,0,0,1,.6-2,3.5,3.5,0,0,1,1.4-1.3,3.8,3.8,0,0,1,1.9-.4,3.5,3.5,0,0,1,2.6.8,3.3,3.3,0,0,1,.9,2.5v.4a2.4,2.4,0,0,1-.4,1.5,2.6,2.6,0,0,1-1.3,1,2.1,2.1,0,0,1,1.4,1,3.6,3.6,0,0,1,.5,1.9Z"
              />
              <path
                id="ANN2"
                class="path2 river flubber visuals"
              ...
              <path
                id="ANN3"
                class="path2 river flubber visuals"
                d="M224.2,139.2H25.8a15.5,15.5,0,0,0,0,31H224.2a15.5,15.5,0,0,0,0-31ZM29.6,157.7a3.8,3.8,0,0,1-.4,1.9,3,3,0,0,1-1.3,1.2,4.2,4.2,0,0,1-2,.4,4.6,4.6,0,0,1-2.1-.4,3.3,3.3,0,0,1-1.4-1.2,3.4,3.4,0,0,1-.6-2h2.5a1.4,1.4,0,0,0,.2.7l.4.4.7.2a1.8,1.8,0,0,0,1.1-.4,1.8,1.8,0,0,0,.3-1.1v-.3a1.8,1.8,0,0,0-.3-1.1.9.9,0,0,0-.8-.4H24.8v-2.3h1.1a.8.8,0,0,0,.7-.4,2,2,0,0,0,.2-.9v-.3a1.2,1.2,0,0,0-.3-.9.8.8,0,0,0-.7-.3l-.6.2a.8.8,0,0,0-.5.5,1.4,1.4,0,0,0-.2.7H22a4.3,4.3,0,0,1,.6-2,3.5,3.5,0,0,1,1.4-1.3,3.8,3.8,0,0,1,1.9-.4,4,4,0,0,1,2.6.8,3.3,3.3,0,0,1,.9,2.5v.4a2.4,2.4,0,0,1-.4,1.5,2.6,2.6,0,0,1-1.3,1,2.4,2.4,0,0,1,1.4,1,3.6,3.6,0,0,1,.5,1.9Z"
              />
              <path
                id="ANN4"
                class="path2 river flubber visuals"
                d="M224.3,139.2H25.9a15.5,15.5,0,0,0,0,31H224.3a15.5,15.5,0,0,0,0-31ZM69.5,164.7a10.1,10.1,0,1,1,10.1-10A10,10,0,0,1,69.5,164.7Zm110.7,0a10.1,10.1,0,1,1,10-10A10.1,10.1,0,0,1,180.2,164.7Z"
              />
              <path
                id="ANN5"
                class="path2 river flubber visuals"
            ...
            >
              <path
                ...
                d="M25.9,20.4A15.5,15.5,0,1,0,41.4,35.9,15.5,15.5,0,0,0,25.9,20.4Zm1.6,22H25.1V32.5l-1.6.5V30.5l1.9-.9h2.1Z"
              />
              <path
                id="ANN2"
                class="path3 other flubber visuals"
            ...
            >
              <path
                ...
                d="M25.9,198.6a15.5,15.5,0,1,0,15.5,15.5A15.4,15.4,0,0,0,25.9,198.6Zm4,20h-1v2H26.5v-2H21.4v-2.2l3.9-8.6H28l-3.8,8.5h2.3V213h2.4v3.3h1Z"
              />
              <path
                id="ANN2"
                class="path5 other flubber visuals"
              ...
              <path
                id="ANN5"
                class="path5 other flubber visuals"
                d="M135.1,218.8H114.9a10.1,10.1,0,0,0,0,20.1h20.2a10.1,10.1,0,0,0,0-20.1Zm-14.2,14.8h-6.1v-.7a2.8,2.8,0,0,1,.1-.9,3,3,0,0,1,.4-.8l.5-.7.6-.6.7-.5.7-.6.5-.5.5-.5.3-.6c0-.2.1-.5.1-.7s-.1-.5-.1-.7l-.4-.5-.5-.2h-.6a2.5,2.5,0,0,0-1.2.2,2.7,2.7,0,0,0-1.2.9v-1.5l.6-.4.6-.3.7-.2h2l.9.5.6.9a3.1,3.1,0,0,1,0,2.2,3.6,3.6,0,0,1-.4.9l-.6.8-.9.7a2.7,2.7,0,0,1-.8.7l-.7.6-.5.5a1.4,1.4,0,0,0-.2.6h4.4Zm1.7-8a1.8,1.8,0,0,1,.6-1.4,2.1,2.1,0,0,1,1.3-.5v.9a.7.7,0,0,0-.6.3,1,1,0,0,0,0,1.4.7.7,0,0,0,.6.3v.9a1.8,1.8,0,0,1-1.3-.6A1.6,1.6,0,0,1,122.6,225.6Zm3.3,1.3a1.6,1.6,0,0,1-1.3.6v-.9a.9.9,0,0,0,.7-.3,1.1,1.1,0,0,0,.3-.7,1,1,0,0,0-1-1v-.9a1.9,1.9,0,0,1,1.3.5,1.8,1.8,0,0,1,.6,1.4A1.6,1.6,0,0,1,125.9,226.9Zm9.3-1.2a4,4,0,0,0-2.2-.6,3.2,3.2,0,0,0-2.5,1,3.6,3.6,0,0,0-1,2.7,3.6,3.6,0,0,0,.9,2.6,3.3,3.3,0,0,0,2.4,1,4.3,4.3,0,0,0,2.4-.7v1.5a5.4,5.4,0,0,1-2.7.6,4.4,4.4,0,0,1-3.4-1.4,4.6,4.6,0,0,1-1.3-3.5,5.4,5.4,0,0,1,1.4-3.8,4.9,4.9,0,0,1,3.7-1.4,5.3,5.3,0,0,1,2.3.4Z"
              />
              <path
                id="ANN6"
                class="path5 other flubber visuals"
                d="M178.1,218.8H114.9a10.1,10.1,0,0,0,0,20.1h63.2a10.1,10.1,0,0,0,0-20.1Zm-57.2,14.8h-6.1v-.7a2.8,2.8,0,0,1,.1-.9,3,3,0,0,1,.4-.8l.5-.7.6-.6.7-.5.7-.6.5-.5.5-.5.3-.6c0-.2.1-.4.1-.7s-.1-.5-.1-.7l-.4-.5-.5-.2h-.6a2.5,2.5,0,0,0-1.2.2,2.7,2.7,0,0,0-1.2.9v-1.5l.6-.4.6-.3.7-.2h2l.9.5.6.9a3.1,3.1,0,0,1,0,2.2,3.6,3.6,0,0,1-.4.9l-.6.8-.9.7a2.7,2.7,0,0,1-.8.7l-.7.6-.5.5a1.4,1.4,0,0,0-.2.6h4.4Zm1.7-8a1.8,1.8,0,0,1,.6-1.4,2.1,2.1,0,0,1,1.3-.5v.9a.7.7,0,0,0-.6.3,1,1,0,0,0,0,1.4.7.7,0,0,0,.6.3v.9a1.8,1.8,0,0,1-1.3-.6A1.6,1.6,0,0,1,122.6,225.6Zm3.3,1.3a1.6,1.6,0,0,1-1.3.6v-.9a.9.9,0,0,0,.7-.3,1.1,1.1,0,0,0,.3-.7,1,1,0,0,0-1-1v-.9a1.9,1.9,0,0,1,1.3.5,1.8,1.8,0,0,1,.6,1.4A1.6,1.6,0,0,1,125.9,226.9Zm9.3-1.2a4,4,0,0,0-2.2-.6,3.2,3.2,0,0,0-2.5,1,3.6,3.6,0,0,0-1,2.7,3.6,3.6,0,0,0,.9,2.6,3.3,3.3,0,0,0,2.4,1,4.3,4.3,0,0,0,2.4-.7v1.5a5.4,5.4,0,0,1-2.7.6,4.4,4.4,0,0,1-3.4-1.4,4.6,4.6,0,0,1-1.3-3.5,5.4,5.4,0,0,1,1.4-3.8,4.9,4.9,0,0,1,3.7-1.4,5.3,5.3,0,0,1,2.3.4Zm42.9,12.2H139.4a10,10,0,0,0,5.7-9.1,9.9,9.9,0,0,0-5.7-9h38.7a9.1,9.1,0,0,1,0,18.1Z"
              />
              <path
                id="ANN7"
                class="path5 other flubber visuals"
                d="M178.1,218.8H114.9a10.1,10.1,0,0,0,0,20.1h63.2a10.1,10.1,0,0,0,0-20.1Zm-61,14.8h-6.2v-.7a2.8,2.8,0,0,1,.1-.9,3,3,0,0,1,.4-.8l.5-.7.6-.6.7-.5.7-.6.6-.5.4-.5.3-.6a1.5,1.5,0,0,0,.1-.7,1.7,1.7,0,0,0-.1-.7l-.4-.5-.5-.2h-.6a2.5,2.5,0,0,0-1.2.2l-1.2.9v-1.5l.6-.4.6-.3.7-.2h2l.9.5a1.8,1.8,0,0,1,.6.9,3.6,3.6,0,0,1,.2,1.1,3.7,3.7,0,0,1-.1,1.1,4.1,4.1,0,0,1-.5.9c-.1.3-.4.5-.6.8l-.9.7a2.7,2.7,0,0,1-.8.7l-.7.6-.5.5a1.4,1.4,0,0,0-.2.6h4.5Zm6.7-.6a4.5,4.5,0,0,1-2.6.8,5.4,5.4,0,0,1-2.4-.5v-1.5a3.6,3.6,0,0,0,2.2.7,2.5,2.5,0,0,0,1.6-.4,1.4,1.4,0,0,0,.6-1.2c0-1.1-.9-1.7-2.6-1.7h-.8v-1.3h.8c1.5,0,2.2-.5,2.2-1.5s-.6-1.5-1.7-1.5a3.4,3.4,0,0,0-1.9.7v-1.4a4.7,4.7,0,0,1,2.4-.5,3.7,3.7,0,0,1,2.1.6,2.1,2.1,0,0,1,.8,1.7,2.5,2.5,0,0,1-2,2.5h0a2.7,2.7,0,0,1,1.7.8,2,2,0,0,1,.6,1.5A3,3,0,0,1,123.8,233Zm2.7-7.4a1.8,1.8,0,0,1,.6-1.4,2.1,2.1,0,0,1,1.3-.5v.9a.7.7,0,0,0-.6.3.9.9,0,0,0-.3.7,1.4,1.4,0,0,0,.2.7.9.9,0,0,0,.7.3v.9a1.8,1.8,0,0,1-1.3-.6A1.6,1.6,0,0,1,126.5,225.6Zm3.3,1.3a1.8,1.8,0,0,1-1.3.6v-.9a.7.7,0,0,0,.6-.3,1.1,1.1,0,0,0,.3-.7.9.9,0,0,0-.3-.7.6.6,0,0,0-.6-.3v-.9a2.1,2.1,0,0,1,1.3.5,1.8,1.8,0,0,1,.6,1.4A1.6,1.6,0,0,1,129.8,226.9Zm9.3-1.2a4,4,0,0,0-2.2-.6,3.2,3.2,0,0,0-2.5,1,3.6,3.6,0,0,0-1,2.7,3.6,3.6,0,0,0,.9,2.6,3.3,3.3,0,0,0,2.4,1,4.8,4.8,0,0,0,2.4-.7v1.5a5.4,5.4,0,0,1-2.7.6,4.7,4.7,0,0,1-3.5-1.4,5.8,5.8,0,0,1,.2-7.3,4.9,4.9,0,0,1,3.7-1.4,5.3,5.3,0,0,1,2.3.4Zm39,12.2H139.4a10,10,0,0,0,5.7-9.1,9.9,9.9,0,0,0-5.7-9h38.7a9.1,9.1,0,0,1,0,18.1Z"
              />
              <path
                id="ANN8"
